...
> One of the 3 hardest problems in computer science, along with naming things, off-by-one errors, and not using this joke
...
## Another Best Tool for the Job

- `AngleSharp` => `HttpClient`
- .NET Core 3.1 => .NET 5
