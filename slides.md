...
<i class="fa-regular fa-envelope"></i> [Steve @ ecoAPM .com](mailto:Steve@ecoAPM.com)
...
- 63 countries get majority of electricity from renewables (<10 in 2021)
...
- parallelized our work (multitasked while async code was running)
- eliminated duplicated effort
- optimized DB queries
- cached data / calculations
...
> [https:// Steve Desmond .ca / talks](https://stevedesmond.ca/talks)
