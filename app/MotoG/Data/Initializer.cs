...
namespace MotoG.Data
{
	public class Initializer
	{
		...
		public async Task Run()
		{
			...
			, ('Moto G', 'BestBuy', 'https://www.bestbuy.com/site/6441176.p', '\\""currentPrice\\"":[ ]?([\d\.]+),')
			...
			, ('Nokia 5.4', 'BestBuy', 'https://www.bestbuy.com/site/6453856.p', '\\""currentPrice\\"":[ ]?([\d\.]+),')
			, ('Nokia 5.4', 'Newegg', 'https://www.newegg.com/p/N82E16875205602', '""FinalPrice"":[ ]?([\d\.]+),')
			, ('Nokia 5.4', 'Nokia', 'https://www.nokia.com/phones/en_us/nokia-5-4', 'div.price.lg')
			");
			...
			for (var x = 3; x <= 100; x++)
			{
				for (var y = 1; y < 10; y++)
				{
					query.AppendLine($@", ('jPhone {x}', 'Fake Store {y}', 'http://localhost', '#price')");
				}
			}
